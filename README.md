# <!> DUE TO THE REMOVAL OF UPX COMPRESSION, OFFICIAL BUILDS AVAILIBLE FROM PTERODACTYL NOW WORK ON ORACLE LINUX. GOING FORWARD YOU SHOULD USE THE OFFICIAL BUILDS FROM PTERODACTYL INSTEAD. <!>
